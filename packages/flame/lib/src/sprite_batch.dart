...
class SpriteBatch {
  ...
  Future<Image> _generateFlippedAtlas(Image image) {
    ...
    print('_generateFlippedAtlas : ${image.width} ${image.height}');
  ...
  void render(
    ...
    if (useAtlas) {
      ...
      // print(_flippedSources);
      // print('atlas size:$id${atlas.size}');
      // canvas.drawImage(
      //   atlas,
      //   Offset(
      //     0,
      ...
      // );
      // if (flippedAtlas != null) {
      //   canvas.drawImage(flippedAtlas!, Offset(0, height.toDouble()), paint);
      // }
    } else {
